...
export const webhookEventsTable = pgTable(
  "webhook_events",
  {
    ...
    source: text("source", {
      enum: ["ghl_lead", "bask_order", "bask_questionnaire", "bask_payment_failed", "bask_payment_succeeded", "bask_prescription_written", "bask_order_shipped", "iblusend_message", "email_inbound"],
    }).notNull(),
