...
describe("Webhooks", () => {
  ...
  describe("Bask order shipped", () => {
    it("matches an existing customer by external identity, sets orderShipped + trackingNumber, sends the notice — with only the fields Bask's real event actually sends (no eventId, no email)", async () => {
      sendMessageMock.mockClear();
