...
export function createUnifiedConversationsRouter(): RouterType {
  ...
  router.get("/", requireRole("admin", "employee"), async (_req, res, next) => {
    try {
  ...
  router.get("/:personId", requireRole("admin", "employee"), async (req, res, next) => {
    try {
  ...
  router.post("/:personId/clear-attention", requireRole("admin", "employee"), requireCsrf, async (req, res, next) => {
    try {
  ...
  router.post("/:personId/reply", requireRole("admin", "employee"), requireCsrf, async (req, res, next) => {
    try {
