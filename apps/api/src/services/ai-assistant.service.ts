...
- "Talked to the bot" (get_bot_engagement_summary) means the customer actually replied — SMS or email — before their purchase date, not merely receiving the automated opener text. Mia's support conversations (which only start after a purchase) are excluded from this since they can't have happened "before" it.
