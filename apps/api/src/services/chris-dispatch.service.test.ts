...
describe("processInboundMessage", () => {
  ...
  it("does NOT schedule a re-engagement text for a different objection reaching stage 2, or think_about_it/price at an earlier stage", async () => {
    ...
    runChrisTurnMock.mockResolvedValueOnce(okResult({ objectionKey: "not_qualified", objectionStage: 2, nextQuestion: null }));
    ...
    runChrisTurnMock.mockResolvedValueOnce(okResult({ objectionKey: "price", objectionStage: 1, nextQuestion: "What price were you hoping for?" }));
