...
const BOT_NAME: Record<ConversationPersona, string> = { sales: "Chris", support: "Mia" };
...
function SalesResponseSummary() {
  ...
  return (
    <Card className="mb-4">
      ...
      <p className="mt-2 text-xs text-gray-400">Sales (Chris) leads only, each contact counted once regardless of channel or how many messages went back and forth.</p>
    </Card>
  );
}
